...
<div id="footer"><b><?=$core_settings->company; ?></b> | <?=$core_settings->email; ?><?php if ($core_settings->invoice_tel != "") {
        ...
        <?php if ($core_settings->bank_accountnr != "") {
            echo " | ".$core_settings->bank_accountnr;
        }; ?>
        <?php if ($core_settings->chamber_commerce != "") {
            echo " | KVK:".$core_settings->chamber_commerce;
        }; ?>
...
<div class="top-background">
   <table width="100%" cellspacing="0" >
        ...
        echo base_url();
         ...
         <tr>
            <td style="vertical-align:top"><strong><?=$invoice->company->name;?></strong></td>
            <td class="right" style="vertical-align:top"><strong><?=$core_settings->company;?></strong></td>
        </tr> 
        <tr>
            <td style="vertical-align:top"><?php if (is_object($invoice->company->client)) {
        ?> T.a.v. <?=$invoice->company->client->firstname; ?> <?=$invoice->company->client->lastname; ?></td>
            <td class="right" style="vertical-align:top"><?=$core_settings->invoice_contact;?><?php
    } ?></td>
        </tr>
        <tr>
            <td style="vertical-align:top"><?=$invoice->company->address;?></td>
            <td class="right" style="vertical-align:top"><?=$core_settings->invoice_address;?></td>
        </tr>
        <tr>
            <td style="vertical-align:top"><?=$invoice->company->zipcode;?> <?=$invoice->company->city;?></td>
            <td class="right" style="vertical-align:top"><?=$core_settings->invoice_city;?></td>
        </tr>
        <tr>
...
<div>
    ...
    <?php if (isset($htmlPreview)) {
        ?>
<div id="footer"><b><?=$core_settings->company; ?></b> | <b><?=$core_settings->email; ?></b>
  <?php if ($core_settings->invoice_tel != "") {
            echo " | ".$core_settings->invoice_tel;
        }; ?>
        <?php if ($core_settings->bank_accountnr != "") {
            echo " | ".$core_settings->bank_accountnr;
